...
![traffic sumulation](data/traffic-simulation-final.gif)

**project structure**
![project structrue](data/traffic-simulation-structre.jpg)

This is the project for traffic simulation using concurrency.
